...
export const Hero = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden grain">
      ...
      <div className="absolute bottom-1/4 left-[5%] w-96 h-96 rounded-full bg-gold/10 blur-3xl animate-float-slow" style={{ animationDelay: "2s" }} />
      ...
      <div className="relative z-10 container-px mx-auto max-w-7xl pt-32 pb-24 w-full">
        <div className="grid lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-8">
            <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full glass text-white/95 text-sm font-medium mb-8 animate-fade-in-down">
              ...
              <span className="font-semibold">Trusted by 5,000+ travellers worldwide</span>
            </div>
            ...
            <p className="mt-8 text-lg md:text-xl text-white/85 max-w-2xl leading-relaxed animate-fade-in font-light" style={{ animationDelay: "0.2s", opacity: 0 }}>
              Maharaj Travelling Agency crafts seamless international experiences — premium flights, expert visa support and bespoke tours, designed around you.
            </p>

            <div className="mt-10 flex flex-col sm:flex-row gap-4 animate-fade-in" style={{ animationDelay: "0.4s", opacity: 0 }}>
            ...
            {/* Trust badges */}
            <div className="mt-12 flex flex-wrap items-center gap-6 text-white/80 animate-fade-in" style={{ animationDelay: "0.6s", opacity: 0 }}>
              {[
          ...
          {/* Floating stat card */}
          <div className="lg:col-span-4 hidden lg:block animate-fade-in" style={{ animationDelay: "0.5s", opacity: 0 }}>
            <div className="relative">
              ...
              <div className="relative glass rounded-3xl p-7 text-white space-y-5">
                ...
                <div>
                  <div className="text-xs text-white/60 uppercase tracking-wider">Popular Route</div>
                  <div className="font-display text-2xl font-bold mt-1">London → Dubai</div>
                  <div className="text-sm text-white/70 mt-1">Direct • 7h 15m</div>
                </div>
                <div className="h-px bg-white/15" />
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <div className="text-xs text-white/60">Starting from</div>
                    <div className="font-display text-3xl font-bold text-accent-glow">£389</div>
                  </div>
                  <div>
                    <div className="text-xs text-white/60">Available</div>
                    <div className="font-display text-3xl font-bold">24<span className="text-lg text-white/60">/day</span></div>
                  </div>
                </div>
                <Button asChild variant="hero" size="sm" className="w-full">
                  <a href="#contact">Inquire Now <ArrowRight className="h-3.5 w-3.5" /></a>
                </Button>
              </div>
            </div>
          </div>
        ...
        {/* Stats bar */}
        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-6 animate-fade-in" style={{ animationDelay: "0.7s", opacity: 0 }}>
          {[
