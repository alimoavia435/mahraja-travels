import { CheckCircle2, Globe2, ShieldCheck, Sparkles, Award } from "lucide-react";
import aboutImg from "@/assets/about.jpg";

const highlights = [
  { icon: ShieldCheck, title: "Trusted Service", desc: "Over a decade of dependable, transparent travel expertise." },
  { icon: Globe2, title: "Global Destinations", desc: "From the UK to every corner of the world — we cover it all." },
  { icon: CheckCircle2, title: "Customer Satisfaction", desc: "Thousands of delighted travellers and counting." },
  { icon: Sparkles, title: "Smooth Experience", desc: "Stress-free planning, booking and end-to-end support." },
];

export const About = () => {
  return (
    <section id="about" className="py-28 md:py-36 bg-gradient-soft relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          <div className="relative">
            ...
            <div className="relative">
              ...
              <div className="absolute -top-6 -right-6 bg-card rounded-2xl shadow-elevated p-5 hidden md:flex items-center gap-3 max-w-[260px] border border-border/40">
                ...
                <div>
                  <div className="font-bold text-primary text-sm">Award Winning</div>
                  <div className="text-xs text-muted-foreground">Excellence in service 2024</div>
                </div>
              </div>
              ...
              <div className="absolute -bottom-8 -left-8 bg-card rounded-2xl shadow-elevated p-6 hidden md:block max-w-[240px] border border-border/40">
                <div className="flex items-baseline gap-1">
                  ...
                  <div className="font-display text-2xl font-bold text-accent">%</div>
                </div>
                ...
                <div className="mt-3 flex -space-x-2">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="h-7 w-7 rounded-full bg-gradient-ocean ring-2 ring-card" />
                  ))}
                  <div className="h-7 w-7 rounded-full bg-accent-soft text-accent text-xs font-bold grid place-items-center ring-2 ring-card">+5K</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <h2 className="mt-5 font-display text-4xl md:text-5xl lg:text-6xl font-bold text-primary leading-[1.05] text-balance">
              Crafting <span className="italic text-accent font-light">unforgettable</span> journeys, one traveller at a time.
            </h2>
            <p className="mt-7 text-muted-foreground text-lg leading-relaxed">
              At Maharaj Travelling Agency, we combine years of expertise with a deep love for travel. From the United Kingdom to destinations across Europe, Asia and beyond, we make international travel simple, safe and inspiring.
            </p>
